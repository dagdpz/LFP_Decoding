function lfp_tfa_cfg = lfp_decode_define_settings(settings_filepath)
...
%%%%%%%%%%%%%%%%%%%%%%%%%[DAG mfile header version 1]%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ~lfp_tfa_cfg.read_decode_LFP && ~exist(lfp_tfa_cfg.decode_lfp_file, 'file')
        lfp_tfa_cfg.read_decode_LFP = true;
    end
    ...
    save(fullfile(lfp_tfa_cfg.root_results_fldr, ['lfp_tfa_decode_settings_' lfp_tfa_cfg.version '.mat']), ...
        'lfp_tfa_cfg');
