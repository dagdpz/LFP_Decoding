...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_IH_IS_control_vs_fake';
...
if ~lfp_decode_cfg.process_LFP
    lfp_decode_cfg.proc_lfp_folder = ...
        'Y:\Projects\PPC_pulv_eye_hand\LFP\Linus\Linus_MIP_control\Processed LFP';
end
...
lfp_decode_cfg.info_filepath = 'Y:\Projects\PPC_pulv_eye_hand\ephys\MIP_dPul_inj_working_post_sfn\Lin_sorted_neurons.xls';
...
lfp_decode_cfg.use_datasets = [41];
...
lfp_decode_cfg.session_info(1) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20170714', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\MIP_dPul_inj_working_post_sfn\sites_Linus_20170714.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', 2, ...
           'sites_idx',      []);       
...
lfp_decode_cfg.session_info(2) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20170721', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\MIP_dPul_inj_working_post_sfn\sites_Linus_20170721.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', 2, ...
           'sites_idx',      []);
...
lfp_decode_cfg.session_info(3) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20170803', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\MIP_dPul_inj_working_post_sfn\sites_Linus_20170803.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', 2, ...
           'sites_idx',      []);
...
lfp_decode_cfg.session_info(4) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20170817', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\MIP_dPul_inj_working_post_sfn\sites_Linus_20170817.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', 2, ...
           'sites_idx',      []);
...
% This is for the hemisphere comparison! Left---
% cl = 0;
% 
% cl = cl + 1;
...
% lfp_decode_cfg.decode.classes(cl).hs_label = 'IH IS';
% lfp_decode_cfg.decode.classes(cl).label = 'Instr control IHIS';
% 
% cl = cl + 1;
% lfp_decode_cfg.decode.classes(cl).target = 'MIP_L';
...
% lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
% lfp_decode_cfg.decode.classes(cl).hs_label = 'IH IS';
% lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation IHIS';

% This is for the hemisphere comparison! Right---
cl = 0;
...
lfp_decode_cfg.compare.effectors = 4;
...
lfp_decode_cfg.compare.reach_hands = {'R'}; %Is this used?
...
lfp_decode_cfg.compare.reach_spaces = {'R'};  
