...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_inactivation_LSvsRS';
...
lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation LS';
...
lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation RS';
