...
lfp_decode_cfg.results_folder = 'Y:\Personal\Sarath\Results\LFP_Decoding_Results';
...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_inactivation_CH_ISvsCS';
...
lfp_decode_cfg.read_decode_LFP = false;
...
lfp_decode_cfg.info_filepath = 'Y:\Projects\PPC_pulv_body_signals\ephys\MIP_inactivation_20190314\Mag_sorted_neurons.xls';
...
lfp_decode_cfg.compare.choice_trials = [0, 1]; 
...
lfp_decode_cfg.compare.reach_hands = {'L', 'R'};
...
lfp_decode_cfg.compute_avg_across = {'sessions', 'sites'}; 
...
%   pdf
lfp_decode_cfg.save_fig_format = {'png', 'pdf'};