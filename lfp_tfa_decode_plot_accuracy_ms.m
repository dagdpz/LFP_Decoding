function lfp_tfa_decode_plot_accuracy_ms( lfp_decode_accuracy, figtitle, results_folder )
    ...
    for s = 1:size(lfp_decode_accuracy.test_accuracy, 1)
        ...
        for ep = 1:length(lfp_decode_accuracy.timebins)
            ...
            shadedErrorBar(timebin_samples(1:length(lfp_decode_accuracy.timebins{ep})), ...
                        nanmean(lfp_decode_accuracy.test_accuracy{ep}, 2), ...
                        nanstd(lfp_decode_accuracy.test_accuracy{ep}, 0, 2), ...
                        'lineProps','b');
