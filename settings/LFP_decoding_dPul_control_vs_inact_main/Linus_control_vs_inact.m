...
lfp_decode_cfg.version = 'LFP_decoding_MIPR_Instr_IH_IS_control_vs_inact';
...
if ~lfp_decode_cfg.process_LFP
    lfp_decode_cfg.proc_lfp_folder = ...
        'Y:\Projects\PPC_pulv_eye_hand\LFP\Linus_dPul_MIP_inactivation\Processed LFP';
end
...
lfp_decode_cfg.use_datasets = [31];
...
% 
% cl = cl + 1;
% lfp_decode_cfg.decode.classes(cl).target = 'MIP_R';
% lfp_decode_cfg.decode.classes(cl).perturbation = 0;
% lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
% lfp_decode_cfg.decode.classes(cl).hs_label = 'IH IS';
% lfp_decode_cfg.decode.classes(cl).label = 'Instr control IHIS';
...
% lfp_decode_cfg.decode.classes(cl).perturbation = 0;
% lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
% lfp_decode_cfg.decode.classes(cl).hs_label = 'IH CS';
% lfp_decode_cfg.decode.classes(cl).label = 'Instr control IHCS';
...
% lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
% lfp_decode_cfg.decode.classes(cl).hs_label = 'IH CS';
% lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation IHCS';
...
lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
lfp_decode_cfg.decode.classes(cl).hs_label = 'CH IS';
lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation CHIS';
...
lfp_decode_cfg.decode.classes(cl).choice_trial = 0;
lfp_decode_cfg.decode.classes(cl).hs_label = 'CH CS';
lfp_decode_cfg.decode.classes(cl).label = 'Instr inactivation CHCS';
...
lfp_decode_cfg.compare.reach_hands = {'L'}; %Is this used?
