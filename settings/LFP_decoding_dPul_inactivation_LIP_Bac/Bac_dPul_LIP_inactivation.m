...
lfp_decode_cfg.version = 'Bac_dPul_LIP_inactivation';
...
lfp_decode_cfg.info_filepath = 'Y:\Projects\Simultaneous_dPul_PPC_recordings\ephys\dPul_inj_LIP_Bac_3_cont_3_inact\Bac_sorted_neurons.xls';
...
lfp_decode_cfg.use_datasets = [10];
...
lfp_decode_cfg.compare.effectors = 0;
...
lfp_decode_cfg.compare.reach_hands = {'any'}; %Is this used?
